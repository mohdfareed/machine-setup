...
class Display:
    ...
    def header(self, message: str, logger=None):
    ...
    def error(self, message: str, logger=None):
    ...
    def warning(self, message: str, logger=None):
    ...
    def info(self, message: str, logger=None):
    ...
    def success(self, message: str, logger=None):
    ...
    def print(self, message: str, logger=None):
    ...
    def verbose(self, message: str, logger=None):
    ...
    def debug(self, message: str, logger=None):
